# METADATA
# title: tunnel-operator-defectdojo
# scope: package
package plejd.tunneloperator.defectdojo
...
# from report labels applied by Tunnel-operator
...
dd_data := {
    ...
    "metadata": {
      ...
      "scan_type": "Tunnel Operator Scan",
      "test_title": "",
      "verified": true 
    }
  }
...
# entrypoint: true
# description: |
#  Mangle a tunneloperator report and prepare it for being sent to DefectDojo.
