...
func TestEval(t *testing.T) {
	tests := []struct {
		...
		/* cases for templates from `rego-templates` directory */
		{
			...
			regoPackage:  "hooker.rawmessage.html",
			expectedValues: map[string]string{
		...
		},
		{
			...
			regoPackage:  "hooker.rawmessage.json",
			expectedValues: map[string]string{
				"title": "-",
			},
		...
		{
			caseDesc:     "tunnel-jira.rego template",
			inputFile:    "testdata/inputs/tunnel-input.json",
			templateFile: "../rego-templates/tunnel-jira.rego",
			regoPackage:  "hooker.tunnel.jira",
			expectedValues: map[string]string{
				"title": "pom.xml vulnerability scan report",
			},
			expectedDescriptionFile: "testdata/goldens/tunnel-jira.golden",
		},
		{
			caseDesc:     "tunnel-vulns-slack.rego template",
			inputFile:    "testdata/inputs/tunnel-input.json",
			templateFile: "../rego-templates/tunnel-vulns-slack.rego",
			regoPackage:  "hooker.vuls.tunnel.slack",
			expectedValues: map[string]string{
				"title": "Vulnerability scan report",
			},
			expectedDescriptionFile: "testdata/goldens/tunnel-vulns-slack.golden",
		},
		{
		...
		},
		{
			...
			regoPackage:  "hooker.vuls.cyclondx",
			expectedValues: map[string]string{
		...
		},
		{
			...
			regoPackage:  "hooker.servicenow.incident",
			expectedValues: map[string]string{
				"title":    "test",
		...
		},
		{
			...
			regoPackage:  "hooker.servicenow.insight",
			expectedValues: map[string]string{
		...
		{
			caseDesc:     "tunnel-operator-jira.rego template",
			inputFile:    "testdata/inputs/tunnel-operator-input.json",
			templateFile: "../rego-templates/tunnel-operator-jira.rego",
			regoPackage:  "hooker.tunneloperator.jira",
			expectedValues: map[string]string{
				"title": "Vulnerability issue with image library/nginx:1.16 in namespace default",
			},
			expectedDescriptionFile: "testdata/goldens/tunnel-operator-jira.golden",
		},
		{
			caseDesc:     "tunnel-operator-slack.rego template",
			inputFile:    "testdata/inputs/tunnel-operator-input.json",
			templateFile: "../rego-templates/tunnel-operator-slack.rego",
			regoPackage:  "hooker.tunneloperator.slack",
			expectedValues: map[string]string{
				"title": "Vulnerability scan report library/nginx:1.16",
			},
			expectedDescriptionFile: "testdata/goldens/tunnel-operator-slack.golden",
		},
