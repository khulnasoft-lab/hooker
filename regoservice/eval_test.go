...
func TestEval(t *testing.T) {
	tests := []struct {
		...
		{
			caseDesc:     "vul-jira.rego template",
			inputFile:    "testdata/inputs/vul-input.json",
			templateFile: "../rego-templates/vul-jira.rego",
			regoPackage:  "hooker.vul.jira",
			expectedValues: map[string]string{
				"title": "pom.xml vulnerability scan report",
			},
			expectedDescriptionFile: "testdata/goldens/vul-jira.golden",
		},
		{
			caseDesc:     "vul-vulns-slack.rego template",
			inputFile:    "testdata/inputs/vul-input.json",
			templateFile: "../rego-templates/vul-vulns-slack.rego",
			regoPackage:  "hooker.vuls.vul.slack",
			expectedValues: map[string]string{
				"title": "Vulnerability scan report",
			},
			expectedDescriptionFile: "testdata/goldens/vul-vulns-slack.golden",
		},
		{
		...
		{
			caseDesc:     "vul-operator-jira.rego template",
			inputFile:    "testdata/inputs/vul-operator-input.json",
			templateFile: "../rego-templates/vul-operator-jira.rego",
			regoPackage:  "hooker.vuloperator.jira",
			expectedValues: map[string]string{
				"title": "Vulnerability issue with image library/nginx:1.16 in namespace default",
			},
			expectedDescriptionFile: "testdata/goldens/vul-operator-jira.golden",
		},
		{
			caseDesc:     "vul-operator-slack.rego template",
			inputFile:    "testdata/inputs/vul-operator-input.json",
			templateFile: "../rego-templates/vul-operator-slack.rego",
			regoPackage:  "hooker.vuloperator.slack",
			expectedValues: map[string]string{
				"title": "Vulnerability scan report library/nginx:1.16",
			},
			expectedDescriptionFile: "testdata/goldens/vul-operator-slack.golden",
		},
